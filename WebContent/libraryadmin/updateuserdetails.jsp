		...
		<div class="container">
			<div class="col-md-6 offset-md-3">
				<div class="card">
					...
					<div class="card-body">
						<form id="reg-form" action="UpdateUserServlet" method="get">
							<div class="form-group">
								<label for="user_name">User Name</label> <input name="username"
							...
							<div class="form-group">
								<label for="exampleInputEmail1">Email Address</label> <input
									name="useremail"<%-- value="<%=rs.getString("name") %>" --%> type="email" class="form-control"
							...
							<div class="form-group">
								...
								<small id="emailHelp" class="form-text text-muted">
									Passwords must be at least 6 characters </small>
							</div>
				 	<%-- <%
						}
					%> --%>
